...
class ImageModuleServer:
    ...
    def initialize(self):
        ...
        # scopes it to 'images' files.
        self.cse.show_loading_status('Initializing image search engine...')
        self.images_search_engine = get_content_search(self.cfg, 'images')

        self.cse.show_loading_status('Loading the embedding model...')
        self.images_search_engine.initiate(models_folder=self.cfg.main.embedding_models_path)
    ...
    def update_model_ratings(self, files_list, ctx=None):
        ...
        embeddings = self.images_search_engine.process_files(
